...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double trackWidth = 0.594377;
        public static final double wheelBase = 0.596207;
        ...
        /** Meters per Second */
        public static final double maxSpeed = 4.5 * .5; //TODO: This must be tuned to specific robot
        /** Radians per Second */
        public static final double maxAngularVelocity = 10.0 * .5; //TODO: This must be tuned to specific robot
    ...
    public static final HolonomicPathFollowerConfig autoConstants = new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
        ...
        Swerve.wheelBase / 2, // Drive base radius in meters. Distance from robot center to furthest module.
